...
window.greenthumb.controller('gtGarden', ['$scope', '$q', 'gtGetData', '$routeParams', 'gtShared', function ($scope, $q, gtGetData, $routeParams, gtShared) {
    'use strict';
    ...
    if($scope.gardenID !== 'mine'){
        gtGetData.load('src/scripts/models/'+$scope.gardenID+'.js');
    }
